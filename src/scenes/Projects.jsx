        ...
        <section id="projects" className="pt-48 pb-48">
            ...
            <div className="flex justify-center">
                ...
                >
                    ...
                    <Project title="Project 1" subtitle="test substitle"/>
                    <Project title="Project 2" subtitle="test subtitle"/>

                    {/* Row 2 */}
                    <Project title="Project 3" subtitle="test subtitle"/>
                    <Project title="Project 4" subtitle="test subtitle"/>
                    <Project title="Project 5" subtitle="test subtitle"/>

                    {/* Row 3 */}
                    <Project title="Project 6" subtitle="test subtitle"/>
                    <Project title="Project 7" subtitle="test subtitle"/>
                    <div
